...
case 'command':
 listMsg = {
"title": "*B-BOT MENU*",
"description": "Halo kak ${pushname} silahkan pencet tombol dibawah untuk memilih menu!",
...
sections: [
						{
								...
								"rows": [
									{
										"title": "DONASI",
										"description": "Silahkan donasi seiklhasnya.",
										"rowId": "!donasi"
									}
								]
							},
							{
								...
								"rows": [
									{
										"title": "Owner Menu",
										"description": "Klik untuk memunculkan menu khusus OWNER BOT.",
										"rowId": "!ownermenu"
									}
								]
							},
							{
								...
								"rows": [
									{
										"title": "Info Menu",
										"description": "Klik untuk memunculkan menu Info.",
										"rowId": "!infomenu"
									}
								]
							},
							{
								...
								"rows": [
									{
										"title": "Group Menu",
										"description": "Klik untuk memunculkan menu media.",
										"rowId": "!groupmenu"
									}
								]
							},
								...
								"rows": [
									{
										...
										"description": "Klik untuk memunculkan menu Downloader.",
										"rowId": "!downloadmenu"
									}
								]
							},
							{
								...
								"rows": [
									{
										"title": "Search Menu",
										"description": "Klik untuk memunculkan menu Search.",
										"rowId": "searchmenu"
									}
								]
							},
							{
								...
								"rows": [
									{
										"title": "Games Menu",
										"description": "Klik untuk memunculkan menu Games.",
										"rowId": "!gamesmenu"
									}
								]
							},
                            {
								...
								"rows": [
									{
										"title": "Primbon Menu",
										"description": "Klik untuk memunculkan menu Primbon.",
										"rowId": "!primbonmenu"
									}
								]
							},
                            {
								...
								"rows": [
									{
										"title": "Database Menu",
										"description": "Klik untuk memunculkan menu Database.",
										"rowId": "databasemenu"
                                  }
								]
							},
								...
								"rows": [
									{
										...
										"description": "Klik untuk memunculkan menu Anonymous.",
										"rowId": "!anonymousmenu"
                                  }
								]
							},
								...
								"rows": [
									{
										...
										"description": "Klik untuk memunculkan menu Voice Changer.",
...
bbot.sendMessage(from, listMsg, MessageType.listMessage, {contextInfo: { mentionedJid: [sender]},quoted:fvid})
break
case 'menu':
await bbot.send5ButImg(from, `Halo Kak ${pushname} 👋\n\nSaya ${botname}, Bot Ini Adalah Beta Multi-Device WhatsApp.\nJika Anda Menemukan Semacam Bug Atau Kesalahan Mohon Dimaklumi 🙏😔, Lapor Owner Agar Segera Di Perbaiki.\n\n• Library : *Baileys-MD*.\n• Prefix : ( ${prefix} )\n• Waktu Server : ${moment.tz('Asia/Jakarta').format('HH:mm:ss')}\n• Tanggal Server : ${moment.tz('Asia/Jakarta').format('DD/MM/YY')}\n• Wib : ${wib}\n• Wit : ${wit}\n• Wita : ${wita}` + '' + lang.menu(prefix), `${footer}`,thumb, [{"urlButton": {"displayText": "Instagram","url": `${sc}`}},{"urlButton": {"displayText": "Website","url": `${myweb}`}},{"quickReplyButton": {"displayText": "Owner","id": 'owner'}},{"quickReplyButton": {"displayText": "Simple Menu","id": 'simplemenu'}},{"quickReplyButton": {"displayText": "All Menu","id": 'allmenu'}}] )
break
case 'simplemenu':
m.reply(`┌── 「 *Simple Menu* 」
├ ${prefix}groupmenu
...
break
case 'groupmenu':
await bbot.send5ButImg(from, `` + '' + lang.groupmenu(prefix), `${footer}`,thumb, [{"urlButton": {"displayText": "Source Code","url": `${sc}`}},{"urlButton": {"displayText": "Website","url": `${myweb}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Back List","id": 'command'}}] )
break
case 'downloadermenu':
await bbot.send5ButImg(from, `` + '' + lang.downloadermenu(prefix), `${footer}`,thumb, [{"urlButton": {"displayText": "Source Code","url": `${sc}`}},{"urlButton": {"displayText": "Website","url": `${myweb}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Back List","id": 'command'}}] )
break
case 'searchmenu':
await bbot.send5ButImg(from, `` + '' + lang.searchmenu(prefix), `${footer}`,thumb, [{"urlButton": {"displayText": "Source Code","url": `${sc}`}},{"urlButton": {"displayText": "Website","url": `${myweb}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Back List","id": 'command'}}] )
break
case 'randommenu':
await bbot.send5ButImg(from, `` + '' + lang.randommenu(prefix), `${footer}`,thumb, [{"urlButton": {"displayText": "Source Code","url": `${sc}`}},{"urlButton": {"displayText": "Website","url": `${myweb}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Back List","id": 'command'}}] )
break
case 'gamesmenu':
await bbot.send5ButImg(from, `` + '' + lang.gamesmenu(prefix), `${footer}`,thumb, [{"urlButton": {"displayText": "Source Code","url": `${sc}`}},{"urlButton": {"displayText": "Website","url": `${myweb}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Back List","id": 'command'}}] )
break
case 'primbonmenu':
await bbot.send5ButImg(from, `` + '' + lang.primbonmenu(prefix), `${footer}`,thumb, [{"urlButton": {"displayText": "Source Code","url": `${sc}`}},{"urlButton": {"displayText": "Website","url": `${myweb}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Back List","id": 'command'}}] )
break
case 'convertmenu':
await bbot.send5ButImg(from, `` + '' + lang.convertmenu(prefix), `${footer}`,thumb, [{"urlButton": {"displayText": "Source Code","url": `${sc}`}},{"urlButton": {"displayText": "Website","url": `${myweb}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Back List","id": 'command'}}] )
break
case 'mainmenu':
await bbot.send5ButImg(from, `` + '' + lang.mainmenu(prefix), `${footer}`,thumb, [{"urlButton": {"displayText": "Source Code","url": `${sc}`}},{"urlButton": {"displayText": "Website","url": `${myweb}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Back List","id": 'command'}}] )
break
case 'databasemenu':
await bbot.send5ButImg(from, `` + '' + lang.groupmenu(prefix), `${footer}`,thumb, [{"urlButton": {"displayText": "Source Code","url": `${sc}`}},{"urlButton": {"displayText": "Website","url": `${myweb}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Back List","id": 'command'}}] )
break
case 'anonymousmenu':
await bbot.send5ButImg(from, `` + '' + lang.anonymousmenu(prefix), `${footer}`,thumb, [{"urlButton": {"displayText": "Source Code","url": `${sc}`}},{"urlButton": {"displayText": "Website","url": `${myweb}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Back List","id": 'command'}}] )
break
case 'voicechargermenu':
await bbot.send5ButImg(from, `` + '' + lang.voicechargermenu(prefix), `${footer}`,thumb, [{"urlButton": {"displayText": "Source Code","url": `${sc}`}},{"urlButton": {"displayText": "Website","url": `${myweb}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Back List","id": 'command'}}] )
break
case 'ownermenu':
await bbot.send5ButImg(from, `` + '' + lang.onwermenu(prefix), `${footer}`,thumb, [{"urlButton": {"displayText": "Source Code","url": `${sc}`}},{"urlButton": {"displayText": "Website","url": `${myweb}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Back List","id": 'command'}}] )
break
case 'donasi':
await bbot.send5ButImg(from, `` + '' + lang.donasi(), `${footer}`,thumb, [{"urlButton": {"displayText": "Source Code","url": `${sc}`}},{"urlButton": {"displayText": "Website","url": `${myweb}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Back List","id": 'command'}}] )
break
case 'thanksto':
await bbot.send5ButImg(from, `` + '' + lang.thanksto(), `${footer}`,thumb, [{"urlButton": {"displayText": "Source Code","url": `${sc}`}},{"urlButton": {"displayText": "Website","url": `${myweb}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Back List","id": 'command'}}] )
break
            default:
                if (budy.startsWith('=>')) {
